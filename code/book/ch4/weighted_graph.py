...
class WeightedGraph(Generic[V], Graph[V]):
    ...
    def add_edge_by_vertices(self, first: V, second: V, weight: float) -> None:
        self.add_edge_by_indices(self._vertices.index(first), self._vertices.index(second), weight)
...
if __name__ == '__main__':
    ...
    #
    # def Astar_for_city_graph2(start: Node, goal: Node) -> List[Node]:
    #     return astar(city_graph2, start, goal, heuristic)
    #
    # print(city_graph2)
